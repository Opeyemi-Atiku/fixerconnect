            ...
            <div class="job-listings-sec">
              ...
              <div class="job-listing wtabs">
                ...
                <div class="job-style-bx">
                  <i><i class="la la-calendar-o"></i>{{Carbon\Carbon::parse($job->created_at)->diffForHumans()}}</i>
                </div>
                </a>
              </div><!-- Job -->
              @endforeach
              ...
              <div class="row">
                .
                <?php
                $prev = $jobs->currentPage() - 1;
                $next = $jobs->currentPage() + 1;
                $url = Request::fullUrl();
