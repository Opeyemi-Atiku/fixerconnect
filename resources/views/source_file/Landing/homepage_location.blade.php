...
$(function(){
  var map;
  function loadMap(){
    var location = <?php echo json_encode($userResult);?>;
    var lat = location[0].latitude;
    var lng = location[0].longitude;
    var address = location[0].location;
    ...
    for(count = 0; count < location.length; count++){
      var lat = location[count].latitude;
      var lng = location[count].longitude;
      var addr = location[count].location;
      var name = location[count].name;
      var trade = location[count].trade_name;
      var title = name+', '+trade+', '+addr;
